  ...
  return (
    <div className="w-full relative">
      <textarea
        ...
        className={`peer w-full p-4 max-h-[150px] min-h-[150px] pt-6 outline-none bg-white font-light border-2 rounded-md transition disabled:opacity-70 disabled:cursor-not-allowed ${
